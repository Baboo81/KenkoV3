                    ...
                    <div class="box rounded-5 p-4 my-5">
                        <div class="row d-flex align-items-center">
                            <article class="col-md-8">
                                ...
                                <p class="text-muted">Laurier (feuille), Menth poivrée, Eucalyptus, Tea-tree, Citron, Ravintsara, Cardamome.</p>
                                <div class="text-start my-3">
                                    <h4>Usages :<i class="circleA mx-3">A</i><i class="circleT mx-2">T</i></h4>
                                </div>
                                <div class="mb-5">
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Soutien la sphère O.R.L en assainissant les voie respiratoire.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Assainissant atmosphérique.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En topique, diluer avec une HV sur le torse pour ouvrir les voies respiratoires, atténuer la toux, déboucher le nez.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Masque sec : 1gtte dans les mains, placez les mains sur le nez et inhaler.</p>
                        ...
                        <div class="row d-flex align-items-center mb-5">
                            ...
                            <article class="col-md-8 text-md-end">
                                ...
                                <div class="text-start mb-5">
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Pour donner un coup de fouet : 1gtte directement dans la bouche.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Pour soulager les maux de tête : 1gtte en massage sur les tempes, front et sur la nuque.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En cas d'inconfort digestif : 1 à 2 gttes dans de l'eau.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En diffusion : 2gttes, pour retrouver; optimisme, vivacité et joie.</p>
                                </div>
                            </article>
                        </div>
                        <div class="row d-flex align-items-center">
                            <article class="col-md-8">
                                ...
                                <div class="mb-5">
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Soutien les déffenses immunitaires.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Sur le plan émotionnel, ce mélange va aider à poser ses limites afin de protéger leur espace personnel des énergies négatives.</p>
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <article class="col-md-8">
                                ...
                                <div class="mb-5">
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Soutien puissant du systeme immunitaire.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En diffusion, elle renforce le sentiment de sécurité.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En cuisine pour arômatiser une sauce, tremper une pointe de cure dent dans le flacon et ensuite dans la sauce.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En topique : antifongique, virrucide.</p>
                        ...
                        <div class="row d-flex align-items-center mt-5">
                            <article class="col-md-8">
                                ...
                                <div class="mb-5">
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>C'est le mélange digestif, qui va soutenir la sphère digestive à tout les niveaux.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En massage sur le ventre pour soulager ; les crampes, ballonements.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>Sur le plan émotionnel; aide à digérer les expériences de la vie.</p>
                                    <p class="text-muted my-1"><i class="mx-3">&#8226;</i>En interne ; 2gttes dans de l'eau chaude en dessous de 60°C, pour améliorer la digestion après un repas copieux ou trop arrosé.</p>
                            </article>
                            <div class="col-md-4 text-center">
