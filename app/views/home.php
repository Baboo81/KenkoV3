                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mainContent">
                            ...
                            <img src="./assets/img/svg/logoAnimate.svg" alt="Logo animé" id="logoAnimation">
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-md-12 part1 position-relative">
                            ...
                            <div class="card rounded-4 bg-grey p-3 position-absolute top-50 start-50 translate-middle" style="width: 30rem;">
                                <img src="./assets/img/jpeg/Kenko-Ho/kenko-ho.svg" class="card-img-top rounded-3" alt="Image représentant un jardin zen">
                                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 part2 position-relative">
                            ...
                            <div class="card rounded-4 bg-blue p-3 position-absolute top-50 start-50 translate-middle" style="width: 30rem;">
                                <img src="./assets/img/jpeg/Kenko-Web/KenkoWeb.svg" class="card-img-top rounded-3" alt="Image représentant un jardin zen">
                                <div class="card-body">
