            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mainTitleContent my-5">
                        <h2 class="text-muted text-center mb-5">La douleur & les huiles essentielles</h2>
                    ...
                    <div class="box rounded-5 p-4 my-5">
                        <div class="row">
                            <article class="col-md-6">
                                ...
                                <p class="text-muted mb-3">Téléchargez notre guide sur la douleur et les huiles essentielles.</p>
                            </article>
                            <div class="col-md-6">
